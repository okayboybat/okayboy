...
<a href="<?php echo U('/personal');?>" class="n1">DataCenter</a>
<a href="<?php echo U('/percomile');?>" class="n2">Compile</a></h1>

<div class="bloglist left">
	<div class="personal">
		<ul>
			<li><span>email：</span><?php echo session('user')['email'];?>   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="<?php echo U('/deluser');?>">注销</a></li>
			...
			<li><span>手机：</span><?php echo ($personallist['phone']); ?></li>
		</ul>
	</div>	
</div>
<!--right-->
