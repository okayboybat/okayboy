...
<a href="<?php echo U('/gustbook');?>" class="n1">Me</a></h1>
<div class="bloglist left">
   <div id="gustbook" class="cate">
     	<!--这里可以放置第三方留言插件-->      
     <?php if(is_array($gustbook)): $i = 0; $__LIST__ = $gustbook;if( count($__LIST__)==0 ) : echo "还没有人给你留言哦！" ;else: foreach($__LIST__ as $key=>$rows): $mod = ($i % 2 );++$i;?><div class="boardone">
              <p ><?php echo ($rows['content']); ?></p><br><br><br><br>
              <span class="spanone"><?php echo ($i); ?>楼</span>
              <span class="spantwo"><?php echo (date("Y-m-d",$rows['add_time'])); ?> --<?php echo ($rows['nickname']); ?>-- <a href="<?php echo U('./gustbook?id='.$rows['gustbook_id']);?>">删除</a></span>      
        </div><?php endforeach; endif; else: echo "还没有人给你留言哦！" ;endif; ?>	
